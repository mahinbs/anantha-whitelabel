    ...
    >
      <defs>
        <linearGradient id={`${uid}-bg`} x1="4" y1="4" x2="28" y2="28" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="100%" stopColor="#31ACF9" stopOpacity="0.95" />
        </linearGradient>
      </defs>
...
const WELCOME_TEXT_ANALYSIS = `Hey! 👋 I'm your **Infiniate Bot** powered by real-time market data, news and sentiment analysis.
...
const WELCOME_TEXT_FREE = `Hey! 👋 I'm your **Infiniate Bot** powered by real-time market data, news and sentiment analysis.
    ...
    const t = setTimeout(() => {
      ...
      setMessages([{
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          ...
          <Button variant="outline" size="sm"
              className="bg-sky-500/10 border-sky-500/20 hover:bg-sky-500/20 text-xs gap-1.5"
        ...
        <div className="relative">
          ...
          <button onClick={() => setOpen(!open)}
            className={cn(
              ...
              "bg-gradient-to-br from-sky-400 via-primary to-sky-600",
      ...
      <div className={cn(
        ...
        <div className="p-3 px-4 border-b bg-primary/5 flex items-center justify-between rounded-t-2xl shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-sm tracking-tight">Infiniate Bot</p>
