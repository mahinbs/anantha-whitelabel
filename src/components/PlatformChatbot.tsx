...
const FAQS: FAQ[] = [
  {
    ...
    answer: `**Infiniate** is an AI-powered trading intelligence platform that helps you make smarter trading decisions.
...
A higher score doesn't guarantee profit — always manage risk with stop-losses.`,
  },
  {
    ...
    answer: `Getting started with Infiniate is simple!
...
Start with Paper Trades to learn the platform before using real money!`,
  },
  {
    ...
    answer: `Yes — **Infiniate is as real as it gets**.
...
const QUICK_REPLIES: QuickReply[] = [
  { label: "What is Infiniate?", keywords: ["what is this platform"] },
...
export function PlatformChatbot() {
  ...
  const WELCOME: Message = {
    id: "welcome",
    role: "bot",
    text: `Hi there! 👋 I'm **Infiniate Bot** — your support assistant. I can help with anything about the platform: AI predictions, strategies, paper trading, daily analysis, backtesting, and more. Ask me in your own words and I'll answer properly!`,
  };
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    if (faq) {
      ...
      addBotReply(
        `I only answer questions about the Infiniate platform. For anything else, please reach out — we'll help you properly.\n\n${contactLine}`,
        true
      );
    }
  }, [messages, showPhone]);
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b bg-gradient-to-r from-primary/10 to-primary/5 rounded-t-2xl shrink-0">
          ...
          <div className="flex-1">
            <p className="font-semibold text-sm">Infiniate Bot</p>
              ...
              <div className={cn(
                ...
                {msg.isContact && (
                  <div className="mt-3 flex flex-col gap-1.5">
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%2C%20I%20need%20help%20with%20Infiniate`}
