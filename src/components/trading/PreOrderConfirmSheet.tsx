...
const VERDICT_CFG = {
  ...
  buy:        { label: "Buy",         color: "text-sky-400",    bg: "bg-sky-500/10 border-sky-500/30",       icon: TrendingUp },
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  { label: "Likely",      val: analysis.expected_roi.likely,  color: "text-sky-300" },
            ...
            <div className="space-y-3 pt-2 pb-safe">
              {countdown > 0 && (
                <div className="space-y-1.5">
                  ...
                  <Progress value={(1 - countdown / COUNTDOWN_SECS) * 100} className="h-1.5 bg-zinc-800 [&>div]:bg-sky-500" />
                </div>
              )}
              <div className="grid grid-cols-2 gap-3">
                <Button
