            ...
            {strategies.map(s => {
              ...
              return (
                ...
                >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-semibold border transition-all ${
                        fs.open
                          ...
                          : "border-zinc-700 text-zinc-500 hover:border-sky-500/40 hover:text-sky-400"
                      }`}
                  ...
                  {/* ── Fire Signal panel ── */}
                  {fs.open && (
                    <div className="mx-3 mb-3 rounded-lg border border-sky-500/20 bg-zinc-950 p-3 space-y-3">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2 rounded-lg border text-[11px] font-medium transition-all ${
                        entryExitOpen[s.id]
                          ...
                          : "border-zinc-800 bg-zinc-900/50 text-zinc-500 hover:border-sky-500/30 hover:text-sky-400"
                      }`}
                    >
