...
function AffiliateCalculatorSlider({
  ...
  const rangeClass = cn(
    ...
    "appearance-none focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 rounded-lg",
    /* WebKit track */
    ...
    "[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-sky-400",
    ...
    "[&::-moz-range-thumb]:bg-sky-400 [&::-moz-range-thumb]:shadow-[0_2px_12px_rgba(45,212,191,0.45)] [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:border-solid"
  );
  ...
  return (
    <div className="space-y-3 w-full">
      <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
        ...
        <span className="tabular-nums text-lg font-semibold text-sky-400" aria-live="polite">
          {display}
        </span>
      </div>
      <div className="rounded-xl border border-zinc-800 bg-zinc-950/80 px-4 pt-3 pb-1 focus-within:border-sky-500/50 focus-within:ring-2 focus-within:ring-sky-500/25">
        <input
          id={id}
          type="range"
          min={min}
...
const AffiliatePartnerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-sky-500/30 selection:text-sky-100 overflow-x-hidden">
      <Helmet>
        <title>Affiliate partner program | Infiniate.ai</title>
        <meta
          name="description"
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 px-4 overflow-hidden bg-black border-b border-zinc-900">
        ...
        >
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-sky-500/10 rounded-full blur-[100px] animate-pulse" />
          {squares.map((pos, index) => (
            <div
              key={`square-${index}`}
              className="absolute w-[60px] h-[60px] bg-sky-500/5 transition-all duration-1000 ease-in-out backdrop-blur-sm"
        ...
        >
          <motion.div
            variants={fadeUp}
            className="inline-flex flex-wrap items-center justify-center gap-2 px-5 py-2 rounded-full border border-sky-500/20 bg-sky-500/5 backdrop-blur-md mb-8 shadow-[0_0_20px_rgba(20,184,166,0.1)]"
          >
          ...
          >
            ...
            <p>
              With Infiniate.ai, you&apos;re not just referring users—you&apos;re monetizing your audience with a{" "}
          ...
          <motion.p
            variants={fadeUp}
            className="text-sky-400/90 text-sm md:text-base font-medium mb-10"
          >
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/auth">
              <Button className="bg-sky-500 hover:bg-sky-400 text-black font-bold text-lg px-10 py-7 rounded-full shadow-[0_0_40px_rgba(20,184,166,0.3)] hover:shadow-[0_0_60px_rgba(20,184,166,0.5)] transition-all duration-300 hover:scale-[1.02] active:scale-95">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              { label: "Cookie window", value: "90 days", color: "text-sky-400" },
      ...
      >
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            ...
            <div className="rounded-2xl bg-sky-500/10 border border-sky-500/20 p-6 space-y-3">
              <div className="flex justify-between items-baseline gap-4">
                <span className="text-zinc-400 text-sm">Estimated monthly revenue</span>
                <span className="text-2xl font-black text-sky-400 tabular-nums">{formatUsd(monthlyRev)}</span>
              </div>
              <div className="flex justify-between items-baseline gap-4">
      ...
      >
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <motion.div
            variants={fadeUp}
            className="rounded-3xl border border-sky-500/20 bg-sky-500/[0.06] p-8 md:p-10 space-y-6"
          >
            ...
            <p className="text-xl text-white font-semibold border-t border-sky-500/20 pt-6">
              That&apos;s recurring income from a single piece of content—then scale with YouTube, Telegram groups, and
              trading communities into a <span className="text-sky-400">predictable monthly revenue stream</span>.
            </p>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <motion.div variants={fadeUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-4 text-white tracking-tight">
              Why Infiniate.ai is easy to sell
            </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
            {[
              ...
              <motion.div
                variants={fadeUp}
                key={i}
                className="bg-black p-8 rounded-3xl border border-zinc-800 hover:border-sky-500/30 transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-2xl bg-sky-500/10 text-sky-400 flex items-center justify-center text-2xl mb-6">
                  {item.icon}
                </div>
      ...
      >
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-sky-400 font-bold uppercase tracking-widest text-sm mb-6">You bring</h3>
              <ul className="space-y-4 text-zinc-300 text-lg">
                <li className="flex items-center gap-3">
                  <FaCheckCircle className="text-sky-500 shrink-0" /> Audience
                </li>
                <li className="flex items-center gap-3">
                  <FaCheckCircle className="text-sky-500 shrink-0" /> Trust
                </li>
                <li className="flex items-center gap-3">
                  <FaCheckCircle className="text-sky-500 shrink-0" /> Traffic
                </li>
              </ul>
            </motion.div>
            <motion.div
              variants={fadeUp}
              className="rounded-3xl border border-sky-500/25 bg-sky-500/[0.04] p-8 md:p-10"
            >
          ...
          <motion.p variants={fadeUp} className="text-center text-zinc-400 mt-10 text-lg">
            <span className="text-sky-400 font-semibold">You focus on growth.</span>{" "}
      ...
      >
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="relative">
            <div className="hidden md:block absolute top-12 left-0 w-full h-px bg-gradient-to-r from-transparent via-sky-900 to-transparent z-0" />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
              {[
                ...
                <motion.div variants={fadeUp} key={i} className="flex flex-col items-center text-center group">
                  <div className="w-24 h-24 rounded-full bg-black border border-zinc-800 flex flex-col items-center justify-center mb-8 relative z-10 group-hover:border-sky-500 shadow-lg transition-colors">
                    <span className="text-sky-500 text-sm font-bold absolute top-2">{item.step}</span>
                    <div className="text-3xl text-zinc-300 mt-3 group-hover:text-sky-400 transition-colors">
                      {item.icon}
                    </div>
                  </div>
          ...
          <motion.div variants={fadeUp} className="rounded-3xl border border-zinc-800 bg-black/60 p-8 space-y-6">
            {[
              ...
              >
                ...
                <span className="text-sky-400 font-semibold">{row.a}</span>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      >
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-sky-600/10 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-2xl">
          ...
          <motion.ul variants={fadeUp} className="text-left max-w-md mx-auto space-y-3 mb-12 text-zinc-300">
            {[
              ...
              <li key={line} className="flex items-start gap-3">
                <FaCheck className="text-sky-500 mt-1 shrink-0" />
                {line}
              </li>
            ))}
          </motion.ul>
          ...
          <motion.div variants={fadeUp}>
            <Link to="/auth">
              <Button className="bg-sky-500 text-black hover:bg-sky-400 text-lg px-12 py-7 rounded-full font-bold border border-sky-400/50 shadow-[0_0_40px_rgba(20,184,166,0.2)] hover:shadow-[0_0_60px_rgba(20,184,166,0.4)] transition-all duration-300 hover:scale-[1.02] active:scale-95 inline-flex items-center gap-3">
          ...
          <motion.p variants={fadeUp} className="mt-12 text-sm text-zinc-600">
            ...
            <span className="text-sky-500/90">AI trading business opportunity</span>
          </motion.p>
        </div>
      </motion.section>
