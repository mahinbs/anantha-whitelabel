      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        {!webinarLoading && !hasWebinarRegistration && (
          <Card className="border-sky-500/30 bg-sky-500/5">
            <CardHeader className="pb-2">
              <CardTitle className="text-base text-sky-200">
                  ...
                  <button
                    ...
                    className={`rounded-md border px-3 py-2 text-left text-sm transition ${
                      selectedBatchCode === batch.code
                        ...
                        : "border-zinc-700 bg-zinc-900/40 text-zinc-300 hover:border-sky-500/40"
                    }`}
                  >
        ...
        <Tabs defaultValue="trade">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 bg-zinc-900 border border-zinc-800 h-auto gap-1 p-1">
            <TabsTrigger value="trade" className="data-[state=active]:bg-sky-500/20 data-[state=active]:text-sky-300 text-xs sm:text-sm">
              <ShoppingCart className="h-3.5 w-3.5 mr-1.5 shrink-0" />
              Place Order
            </TabsTrigger>
            <TabsTrigger value="portfolio" className="data-[state=active]:bg-sky-500/20 data-[state=active]:text-sky-300 text-xs sm:text-sm">
              <BookOpen className="h-3.5 w-3.5 mr-1.5 shrink-0" />
              Portfolio
            </TabsTrigger>
            <TabsTrigger value="backtest" className="data-[state=active]:bg-sky-500/20 data-[state=active]:text-sky-300 text-xs sm:text-sm">
              <LineChart className="h-3.5 w-3.5 mr-1.5 shrink-0" />
              Backtesting
            </TabsTrigger>
            <TabsTrigger value="sync" className="data-[state=active]:bg-sky-500/20 data-[state=active]:text-sky-300 text-xs sm:text-sm">
              ...
              <CardContent className="space-y-4">
                ...
                {aiAnalysis && (
                  <div className="bg-zinc-800/60 border border-zinc-700 rounded-lg p-3 text-xs text-zinc-300 leading-relaxed whitespace-pre-wrap max-h-48 overflow-y-auto">
                    <p className="text-sky-400 font-semibold mb-1 flex items-center gap-1">
                ...
                <div className="flex gap-2 pt-1">
                  <Button
                    ...
                    className="flex-1 border-zinc-700 text-zinc-300 hover:text-sky-300 hover:border-sky-500/50"
                  >
                    {analysing
