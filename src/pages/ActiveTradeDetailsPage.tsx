...
export default function ActiveTradeDetailsPage() {
    ...
    const ActionPanel = () => (
        <div className="space-y-3">
            ...
            <Button
                variant="default"
                className="w-full bg-sky-600 hover:bg-sky-500 text-white py-5"
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="mt-2 rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 space-y-1">
                                        ...
                                        <p className={`text-xs font-medium ${slip.isZero ? "text-slate-400" : slip.isAdverse ? "text-amber-400" : "text-sky-400"}`}>
