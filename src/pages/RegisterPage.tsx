      ...
      <div className="min-h-screen bg-black text-white font-sans selection:bg-cyan-500 selection:text-black pt-24 pb-16">
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto">
            ...
            <Card className="bg-zinc-900/30 border-zinc-800 backdrop-blur-sm shadow-2xl shadow-sky-900/10">
              <CardContent className="p-6 md:p-8">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      type="text"
                      className="bg-zinc-950/50 border-zinc-800 focus:border-sky-500/50 focus:ring-sky-500/20 h-12"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="date"
                        className="bg-zinc-950/50 border-zinc-800 focus:border-sky-500/50 focus:ring-sky-500/20 h-12 [color-scheme:dark]"
                  ...
                  <div className="flex items-start space-x-3 pt-2">
                    <Checkbox
                      id="declaration"
                      className="mt-1 border-zinc-600 data-[state=checked]:bg-sky-500 data-[state=checked]:border-sky-500"
                  ...
                  <div className="pt-6">
                    <Button
                      disabled={loading}
                      type="submit"
                      className="w-full h-12 bg-sky-500 hover:bg-sky-400 text-black font-semibold text-lg rounded-xl shadow-[0_0_30px_rgba(20,184,166,0.3)] hover:shadow-[0_0_50px_rgba(20,184,166,0.5)] transition-all duration-300"
                    >
                      {loading ? (
                        <>
